<?php 
   ...
   function send_mail($message,$id)
            ...
            $sql = "SELECT * from donor_infos WHERE Blood_Group =  '$blood_group' AND Division = '$division'  HAVING (select donation_infos.donor_id from donation_infos where donation_infos.Last_donate <= '$eligible_date' and donor_infos.id = donation_infos.donor_id)";
...
?>  
    ...
    <table class="table table-striped">
        <thead>
            <h4 style="text-align: center;">All Eligible Donor According to <?php echo $division;?> Division</h4>
            <hr>
         <tr>
       ...
       <tbody>
        ...
        ?>
         ...
         <tr>
            ...
            <td>
                <a class="btn btn-info" href="division_wise_seeking_post.inc.php?id=<?php echo $row2['id'];?>">Send Mail</a>
                <?php 
                    $message = array();
                    //$id = $_SESSION['id'];
    ...
    <div>
         <a class="btn btn-info" style="width: 100%;" href="division_wise_seeking_post.inc.php?id2=<?php echo $row2['id'];?>">Send Mail to All</a>
    </div> 
<!DOCTYPE html>
<html>
<head>
