   ...
   if($_POST)
   {
        ...
        if($_POST['sub_district'] == "NULL")
         ...
         if(count($error_msg) == 0)
         {
            ...
            header("location:sub_district_wise_seeking_post.inc.php?blood_group=".$blood_group."&division=".$division."&district=".$district."&sub_district=".$sub_district); 
         }
   }
?>
<!DOCTYPE html>
...
<div class="row">
     <?php
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header"><h5 style="text-align: center;">Sub-district Wise Donor Search</h5>
                  <hr>
                  <?php
                        if(isset($_SESSION['user']) && $_SESSION['role'] == "admin") { 
                    ?>
