<?php 
   ...
   function send_mail($message,$id)
            ...
            $sql = "SELECT * from donor_infos WHERE  Blood_Group =  '$blood_group' AND Division = '$division' AND District = '$district' AND Sub_District_or_Police_Station = '$sub_district' HAVING (select donation_infos.donor_id from donation_infos where donation_infos.Last_donate <= '$eligible_date' and donor_infos.id = donation_infos.donor_id)";
...
?>  
       ...
       <tbody>
        ...
        ?>
         ...
         <tr>
            ...
            <td>
                <a class="btn btn-info" href="sub_district_wise_seeking_post.inc.php?id=<?php echo $row2['id'];?>">Send Mail</a>
                <?php 
                    $message = array();
                    //$id = $_SESSION['id'];
    ...
    <div>
         <a class="btn btn-info" style="width: 100%;" href="sub_district_wise_seeking_post.inc.php?id2=<?php echo $row2['id'];?>">Send Mail to All</a>
    </div> 
<!DOCTYPE html>
<html>
<head>
