<?php 
   ...
   include("header.php");
    if($_POST)
    {
        $email = $_POST['email'];
        $error_msg = array();
        $query = "SELECT * from donor_infos where E_mail = '$email' Role = 'user'";
        ...
        if(count($error_msg) == 0)
        {
          ...
          header('location:user_all_info_dashboard.php?id='.$id);//This is how send a variable to another page.
          ob_end_flush();
        }
    }
?>
...
<div class="row">
      <?php
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header"><h5>User Info</h5></div>
                <div class="card-body">
